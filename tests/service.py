...
def generate_mock_response():
    ...
    response["chat_message"] = ToolCallSummaryMessage(
        ...
        metadata={},
        content=(
            "Acetaminophen can mask a fever but may reduce the risk of adverse events such as"
            " seizures."
        ),
    ...
    tool_call_execution_event = ToolCallExecutionEvent(
        ...
        content=[
            FunctionExecutionResult(
                content=(
                    "Acetaminophen can mask a fever but may reduce the risk of adverse events such"
                    " as seizures."
                ),
                name="web_search",
                call_id="",
